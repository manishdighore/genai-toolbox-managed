...
func ServeFlags(flags *pflag.FlagSet, opts *ToolboxOptions) {
	...
	flags.StringVar(&opts.Cfg.TLSCert, "tls-cert", "", "Path to TLS certificate file for HTTPS.")
	flags.StringVar(&opts.Cfg.TLSKey, "tls-key", "", "Path to TLS private key file for HTTPS.")
}
